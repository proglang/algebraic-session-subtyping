...
\end{align*}
%
The $\sigma$ labels capture value and selector communication and the
close-style action on a session endpoint.  The mechanization uses one close
label for both ends of a closing synchronization.
%
...
form $(\{e\}\uplus E,L)$ distinguishes one occurrence of $e$ and leaves the
remainder $E$ unchanged; similarly, $(\{e_1,e_2\}\uplus E,L)$ distinguishes
