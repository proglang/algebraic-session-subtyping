...
\begin{mathpar}
    ...
    \inferrule[L-Match]
    {\protocolsfull \and k\in K}
    {\transCtx{\ebind{x}{\TIn{(\TPAppSet \proto K {\overline{U}})}{S}}}
      {\receivel{x}{C_k}}{\ebind{x}{\matchin[k]}}}
    
    \inferrule[L-Sel]
    {\protocolsfull}
    {\transCtx{\ebind{x}{\TOut{(\TPAppSet \proto {\{k\}} {\overline{U}})}{S'}}}
      {\sendl{x}{C_k}}{\ebind{x}{\matchout[k]}}}
    
    \inferrule[L-Close]{}
    {\transCtx{\ebind{x}{\TEnd}}{\closel{x}}{\Empty}}
