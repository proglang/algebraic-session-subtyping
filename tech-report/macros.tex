...
\newcommand{\recc}{\textcolor{ACMPurple}}

% Utitlity macro to define functions always typeset in black.
\newcommand*\BlkFunction[2]{\blk{#1\ifstrempty{#2}{}{(#2)}}}

% abbreviation of the calculus
\newcommand\algstsub{AlgST$^{<:}$\xspace}
...
\newcommand{\TPAppSet}[3]{\typec{{#1}~{#2}~{#3}}}
...
\newcommand\CRep{\termc{\texttt{Rep}}}
\newcommand\CSeq{\termc{\texttt{Seq}}}
\newcommand\CEps{\termc{\texttt{Eps}}}
...
\newcommand{\sendee}[2]{\appe{\sendk}{\paire{\termc{#1}}{\termc{#2}}}}
\newcommand{\receivee}[1]{\receivek\;\termc{#1}}
\newcommand{\closee}[1]{\closek\;\termc{#1}}
...
\newcommand*\LSend{\textsf{!}}
\newcommand*\LRecv{\textsf{?}}
\newcommand*\LFunc{{\to}}
\newcommand*\LEnd{\textsf{End}}
\newcommand*\LUnit{\syntax{Unit}}
\newcommand*\LInt{\syntax{Int}}
\newcommand*\LBranch{\textsf{\&}}
\newcommand*\LChoice{\textsf{+}}
\newcommand*\labset{L_{\textit{Con}}}
\newcommand*\labsetS{\labset^S}
\newcommand*\labsetB{\labset^B}
\newcommand*\Lone{\textsf{1}}
\newcommand*\Ltwo{\textsf{2}}
\newcommand*\sttrans[1]{\xlongrightarrow{\smash{\raisebox{-2pt}{$\scriptstyle \cramped{#1}$}}}}
\newcommand*\notrans{\,{\nrightarrow}}
\newcommand*\stlts[1][]{(V,L,{\sttrans{}_{#1}}\!)}
\newcommand*\stty[1][]{\BlkFunction{\mathcal{T}_{#1}\ifstrempty{#1}{\,}{}}}

\newcommand*\NodePost{\BlkFunction{\operatorname{post}}}
\newcommand*\NodeCycles{\BlkFunction{\operatorname{cycles}}}
\newcommand*\NodeNonCycles{\BlkFunction{\operatorname{non-cycles}}}

\newcommand*\stltsLDefn{
    \{ \LSend, \LRecv, \LBranch, \LChoice, \LEnd, \LFunc, \Lone, \Ltwo \}
      \uplus B
      \uplus C
}
\newcommand*\stltsLDefnCon{
    \{ \LSend, \LRecv, \LBranch, \LChoice, \LEnd, \LFunc \}
      \uplus B
}
\newcommand*\stltsLDefnS{
    \{ \LSend, \LRecv, \LBranch, \LChoice, \LEnd \}
}

\newcommand*\DualRel{\mathrel{\mathcal{D}}}
\newcommand*\PowerSet{\mathscr{P}}
\newcommand*\subtriple[3]{({\sttrans{}_{#1}}, #2, {\sttrans{}_{#3}})}
...
\newcommand*\ToAlgCollect{\BlkFunction{\ToAlgName{collect}}}
\newcommand*\ToAlgSeq[1][\ppm{}]{\BlkFunction{\ToAlgName{seq}^{#1}}}
\newcommand*\ToAlgCons[1][\ppm{}]{\BlkFunction{\ToAlgName{cons}}}
\newcommand*\ToAlgP{\BlkFunction{\ToAlgName{p}}}

\newcommand*\ToAlgSeen{\uptheta}
\newcommand*\ToAlgSeenNil{\varepsilon}
...
\newcommand{\rulenamesub}[1]{\rulename{S}{#1}}   % S- for algorithmic subtyping
\newcommand{\rulenamesubIn}{\rulenamesub{In}}
\newcommand{\rulenamesubOut}{\rulenamesub{Out}}
...
% Referencing an enumeration item.
...
\lstset{
  ...
  morekeywords=[1]{protocol,select,send,receive,match,with,new,fork,close},
...
\newcommand{\subt}{\le}
\newcommand{\paramsSubt}[3]{\typec{\overline{#2}}\mathrel{\preceq_{\typec{#1}}}\typec{\overline{#3}}}

% Subtyping between two LTS (not needed in this form).
\newcommand\SubLTS{\preceq}
% Subtyping between the transition relations of two LTS.
\newcommand\SubNode[1]{\textsc{Sub}_{#1}}
% Subtyping between end-recursive session types.
\newcommand\SubST{\leq}
% Ordering between nodes in an LTS.
\newcommand*\Vleq{\leq_V}

% Typesets its arguments centered in a box typeset with the width of an equals sign.
