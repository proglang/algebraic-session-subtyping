\begin{figure}[t!]
  ...
  \begin{mathpar}
	...
	\inferrule[Act-Send]{}{\trans{\appe{\tappe{\tappe \sendk T}{U}}{\paire v x}}{\sendl xv}{x}}
	
		\inferrule[Act-Match]{k\in J}{\trans{\matchwithe xCyeiJ}{\receivel
	        x{C_k}}{e_k\esubs x{y_k}}}

	\inferrule[Act-Sel]{}{\trans{\appe{\tappe{\selecte{C}}{\overline T}}{x}}{\sendl x{C}}{x}}
	
		\inferrule[Act-Close]{}{\trans{\closee{x}}{\closel x}{\unitk}}
	...
	{\trans{\matchwithe{e_1}CxeiJ}{\lambda}{\matchwithe{e_2}CxeiJ}}
