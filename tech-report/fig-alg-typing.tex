...
\begin{mathpar}
  ...
  \infrule{\rulenameexpMatch}{
    ...
    \forall i\in I: \\ \expSynth {\Gamma_2,\ebind{x_i}{\matchin}} {e_i} {V_i} {\Gamma_i} \\
    \termc{x_i}\not\in\Gamma_i \\
    \typec{V} =_\alpha \typec{V_i} \\
    % \isEquiv{\Gamma_3}{\Gamma_i}
    {\Gamma_3}=_\alpha{\Gamma_i}
  }{
...
\begin{mathpar}
  ...
  {\expSynth{\Gamma_1} e U {\Gamma_2} \\ \typec T =_\alpha\typec U}
