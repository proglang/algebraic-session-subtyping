\begin{figure}[t!]
\declrel{Type synthesis}{$\expSynth{\Gamma_1}eT{\Gamma_2}$}
\begin{mathpar}
  ...
  {\typeAgainst{T}{\kindt} \and \typeAgainst{U}{\kindt} \\
  ...
  \infrule{\rulenameexpMatch}{
    \protocolsfull \\
    \varnothing\ne K\subseteq J\subseteq I \\
    \expSynth {\Gamma_1} e
      {\TIn{(\TPAppSet \proto K {\overline U})}{S}} {\Gamma_2} \\
    \forall i\in J:\quad
      \expSynth {\Gamma_2,\ebind{x_i}{\matchin}} {e_i} {V_i} {\Gamma_i}
      \and \termc{x_i}\not\in\Gamma_i
      \and \Gamma_3 =_\alpha \Gamma_i \\
    \textstyle \typec{V} = \bigsqcup_{i \in J} \typec{V_i} \\
  }{
    \expSynth {\Gamma_1} {\matchwithe eCxeiJ} {V} {\Gamma_3}
  }
\end{mathpar}
\declrel{Type against}{$\expAgainst{\Gamma_1}eT{\Gamma_2}$}
\begin{mathpar}
  \infrule{\rulenameexpCheck}
  {\expSynth{\Gamma_1} e U {\Gamma_2} \\ \typec U \subt \typec T}
