...
%
\begin{lstlisting}
  type IntListS = mualpha. oplus{Cons: !Int.alpha, Nil: End}
\end{lstlisting}
%
...
comes to an end as indicated by the type \lstinline+End+.
%
Type \lstinline+End+ represents a completed channel endpoint and is self-dual.
%
As the name
...
session type \lstinline/IntListS/ corresponds to \lstinline/!IntListP.End/.
