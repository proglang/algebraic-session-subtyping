...
\begin{proof}[Proof of \cref{thm:preservation} (Preservation)]\
  ...
  \begin{enumerate}
    ...
    Conclude applying the substitution lemma (\cref*{lem:substitution}) to (b) and (d), and using \hl{\rulenameexpCheck} together with the definition of the least upper bound.
