...
\begin{proof}[Proof of \cref{thm:preservation} (Preservation)]\
  ...
  \begin{enumerate}
    ...
    Conclude applying the substitution lemma (\cref*{lem:substitution}) to (b) and (d), and using the definition of the least upper bound.
    ...
    $\expSynth{\Gamma_1,\Gamma_2',\Gamma_3}{e_2}{U'}{\hl{\Gamma_3'}}$ with 
    $\hl{\typec{U'} \subt \typec{U}}$ and $\Gamma_3' \subt \Gamma_3$}. By \hl{transitivity of subtyping} 
    we know that \hl{$\typec{U'} \subt \typec{T}$}. Using \rulenameexpCheck
    we conclude that $\expAgainst{\Gamma_1,\Gamma_2',\Gamma_3}{e_2}{T}{\hl{\Gamma_3'}}$.
