...
joinₜ (N-Var NV) (N-Arrow N₂ N₃) = no (λ{ (_ , <:ₜ-var , ())})
...
joinₜ N-Base (N-Arrow N₂ N₃) = no (λ{ (_ , <:ₜ-base , ())})
...
... | yes (N₃⊓N₁ , <:₁ , <:₂)
    = map′ (λ{ (N₂⊔N₄ , <:₃ , <:₄) → N-Arrow N₃⊓N₁ N₂⊔N₄ , <:ₜ-arrow <:₂ <:₃ , <:ₜ-arrow <:₁ <:₄ })
           (λ{ (_ , <:ₜ-arrow <:₁ <:₃ , <:ₜ-arrow <:₂ <:₄) → _ , <:₃ , <:₄})
           (joinₜ N₂ N₄)
joinₜ (N-Arrow N₁ N₂) (N-Poly _ N₃) = no (λ{ (_ , <:ₜ-arrow _ _ , ())})
joinₜ (N-Arrow N₁ N₂) (N-Sub _ N₃) = no (λ{ (_ , <:ₜ-arrow _ _ , ())})
joinₜ (N-Arrow N₁ N₂) (N-ProtoD N₃) = no (λ{ (_ , <:ₜ-arrow _ _ , ())})
joinₜ (N-Pair N₁ N₂) (N-Var NV) = no (λ{ (_ , <:ₜ-pair _ _ , ())})
joinₜ (N-Pair N₁ N₂) N-Base = no (λ{ (_ , <:ₜ-pair _ _ , ())})
joinₜ (N-Pair N₁ N₂) (N-Arrow N₃ N₄) = no (λ{ (_ , <:ₜ-pair _ _ , ())})
...
joinₜ (N-Poly _ N₁) (N-Arrow N₂ N₃) = no (λ{ (_ , <:ₜ-poly _ , ())})
...
joinₜ (N-Sub _ N₁) (N-Arrow N₂ N₃) = no (λ{ (_ , <:ₜ-sub _ , ())})
...
joinₜ (N-ProtoD N₁) (N-Arrow N₂ N₃) = no (λ{ (_ , <:ₜ-data _ , ())})
...
meetₜ (N-Var NV) (N-Arrow N₂ N₃) = no (λ{ (_ , <:ₜ-var , ())})
...
meetₜ N-Base (N-Arrow N₂ N₃) = no (λ{ (_ , <:ₜ-base , ())})
...
... | yes (N₃⊓N₁ , <:₁ , <:₂)
    = map′ (λ{ (N₂⊔N₄ , <:₃ , <:₄) → N-Arrow N₃⊓N₁ N₂⊔N₄ , <:ₜ-arrow <:₂ <:₃ , <:ₜ-arrow <:₁ <:₄ })
           (λ{ (_ , <:ₜ-arrow <:₁ <:₃ , <:ₜ-arrow <:₂ <:₄) → _ , <:₃ , <:₄})
           (meetₜ N₂ N₄)
meetₜ (N-Arrow N₁ N₂) (N-Poly _ N₃) = no (λ{ (_ , <:ₜ-arrow _ _ , ())})
meetₜ (N-Arrow N₁ N₂) (N-Sub _ N₃) = no (λ{ (_ , <:ₜ-arrow _ _ , ())})
meetₜ (N-Arrow N₁ N₂) (N-ProtoD N₃) = no (λ{ (_ , <:ₜ-arrow _ _ , ())})
meetₜ (N-Pair N₁ N₂) (N-Var NV) = no (λ{ (_ , <:ₜ-pair _ _ , ())})
meetₜ (N-Pair N₁ N₂) N-Base = no (λ{ (_ , <:ₜ-pair _ _ , ())})
meetₜ (N-Pair N₁ N₂) (N-Arrow N₃ N₄) = no (λ{ (_ , <:ₜ-pair _ _ , ())})
...
meetₜ (N-Poly _ N₁) (N-Arrow N₂ N₃) = no (λ{ (_ , <:ₜ-poly _ , ())})
...
meetₜ (N-Sub _ N₁) (N-Arrow N₂ N₃) = no (λ{ (_ , <:ₜ-sub _ , ())})
...
meetₜ (N-ProtoD N₁) (N-Arrow N₂ N₃) = no (λ{ (_ , <:ₜ-data _ , ())})
