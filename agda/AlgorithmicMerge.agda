...
joinₜ N-Base (N-Poly N₂) = no (λ{ (T₁ , N , <:ₜ-base , ())})
...
... | yes (T₅ , N₁⊔N₃ , <:₁ , <:₂)
  = map′ (λ{ (T₆ , N₂⊔N₄ , <:₃ , <:₄) → T-Pair T₅ T₆ , N-Pair N₁⊔N₃ N₂⊔N₄ , <:ₜ-pair <:₁ <:₃ , <:ₜ-pair <:₂ <:₄})
         ...
         (joinₜ N₂ N₄)
joinₜ (N-Pair N₁ N₂) (N-Poly N₃) = no (λ{ (T₁ , N , <:ₜ-pair _ _ , ())})
joinₜ (N-Pair N₁ N₂) (N-Sub N₃) = no (λ{ (T₁ , N , <:ₜ-pair _ _ , ())})
joinₜ (N-Pair N₁ N₂) (N-ProtoD N₃) = no (λ{ (T₁ , N , <:ₜ-pair _ _ , ())})
joinₜ (N-Poly N₁) (N-Var NV) = no (λ{ (T₁ , N , <:ₜ-poly _ , ())})
joinₜ (N-Poly N₁) N-Base = no (λ{ (T₁ , N , <:ₜ-poly _ , ())})
joinₜ (N-Poly N₁) (N-Pair N₂ N₃) = no (λ{ (T₁ , N , <:ₜ-poly _ , ())})
...
... | yes refl
  ...
  = map′ (λ{ (_ , _ , <:₁ , <:₂) → T-Sub km≤₂ _ , N-Sub _ , <:ₜ-sub <:₁ , <:ₜ-sub <:₂})
         ...
         (joinₜ N₁ N₂)
joinₜ (N-Sub N₁) (N-Pair N₂ N₃) = no (λ{ (T₁ , N , <:ₜ-sub _ , ())})
...
... | no ⊙₁≢⊙₂ = no (λ{ (T , N , <:ₚ′-proto x x₁ , <:ₚ′-proto x₂ x₃) → ⊙₁≢⊙₂ refl})
... | yes refl
  = map′ (λ{ (T , N , <:₁ , <:₂) → _ , (N-ProtoP {#c = #c₁ ∩ #c₂} {⊙₁} N , (<:ₚ′-proto (p∩q⊆p #c₁ #c₂) <:₁) , (<:ₚ′-proto (p∩q⊆q #c₁ #c₂) <:₂))})
         (λ{ (T , N , <:ₚ′-proto x x₁ , <:ₚ′-proto x₂ x₃) → _ , _ , x₁ , x₃})
         (mergeₚ-meet ⊙₁ N₁ N₂)
meetₚ′ (N-ProtoP N) (N-Up N₁) = no (λ{ (_ , _ , <:ₚ′-proto _ _ , ()) })
meetₚ′ (N-ProtoP N) N-Var = no (λ{ (_ , _ , <:ₚ′-proto _ _ , ()) })
meetₚ′ (N-Up N) (N-ProtoP N₁) = no (λ{ (_ , _ , <:ₚ′-up _ , ()) })
...
meetₚ′ N-Var (N-ProtoP N) = no (λ{ (_ , _ , <:ₚ′-var , ()) })
...
meetₜ (N-Var NV) (N-Poly N₂) = no (λ{ (T₁ , N , <:ₜ-var , ())})
meetₜ (N-Var NV) (N-Sub N₂) = no (λ{ (T₁ , N , <:ₜ-var , ())})
...
meetₜ N-Base (N-Poly N₂) = no (λ{ (T₁ , N , <:ₜ-base , ())})
meetₜ N-Base (N-Sub N₂) = no (λ{ (T₁ , N , <:ₜ-base , ())})
...
meetₜ (N-Arrow {km = km₁} N₁ N₂) (N-Arrow {km = km₂} N₃ N₄)
  rewrite ≤p-irrelevant km₁ km₂
  with joinₜ N₃ N₁
... | no ¬meet = no λ{ (T , N , <:ₜ-arrow <:₁ <:₂ , <:ₜ-arrow <:₃ <:₄) → ¬meet (_ , _ , <:₃ , <:₁)}
... | yes (T₅ , N₃⊓N₁ , <:₁ , <:₂)
    = map′ (λ{ (T₆ , N₂⊔N₄ , <:₃ , <:₄) → T-Arrow km₂ T₅ T₆ , ((N-Arrow N₃⊓N₁ N₂⊔N₄) , (<:ₜ-arrow <:₂ <:₃) , <:ₜ-arrow <:₁ <:₄)})
           (λ{ (T , N , <:ₜ-arrow <:₁ <:₃ , <:ₜ-arrow <:₂ <:₄) → _ , _ , <:₃ , <:₄})
           (meetₜ N₂ N₄)
meetₜ (N-Arrow N₁ N₂) (N-Poly N₃) = no (λ{ (T₁ , N , <:ₜ-arrow _ _ , ())})
meetₜ (N-Arrow N₁ N₂) (N-Sub N₃) = no (λ{ (T₁ , N , <:ₜ-arrow _ _ , ())})
meetₜ (N-Arrow N₁ N₂) N-End = no (λ{ (T₁ , N , <:ₜ-arrow _ _ , ())})
meetₜ (N-Arrow N₁ N₂) (N-Msg p N N₃) = no (λ{ (T₁ , N , <:ₜ-arrow _ _ , ())})
...
... | yes (T₅ , N₁⊓N₃ , <:₁ , <:₂)
  = map′ (λ{ (T₆ , N₂⊓N₄ , <:₃ , <:₄) → T-Pair T₅ T₆ , N-Pair N₁⊓N₃ N₂⊓N₄ , <:ₜ-pair <:₁ <:₃ , <:ₜ-pair <:₂ <:₄})
         (λ{ (_ , _ , <:ₜ-pair <:₁ <:₃ , <:ₜ-pair <:₂ <:₄) → _ , _ , <:₃ , <:₄ })
         (meetₜ N₂ N₄)
meetₜ (N-Pair N₁ N₂) (N-Poly N₃) = no (λ{ (T₁ , N , <:ₜ-pair _ _ , ())})
meetₜ (N-Pair N₁ N₂) (N-Sub N₃) = no (λ{ (T₁ , N , <:ₜ-pair _ _ , ())})
meetₜ (N-Pair N₁ N₂) (N-ProtoD N₃) = no (λ{ (T₁ , N , <:ₜ-pair _ _ , ())})
meetₜ (N-Poly N₁) (N-Var NV) = no (λ{ (T₁ , N , <:ₜ-poly _ , ())})
meetₜ (N-Poly N₁) N-Base = no (λ{ (T₁ , N , <:ₜ-poly _ , ())})
meetₜ (N-Poly N₁) (N-Pair N₂ N₃) = no (λ{ (T₁ , N , <:ₜ-poly _ , ())})
meetₜ (N-Poly N₁) (N-Arrow N₂ N₃) = no (λ{ (T₁ , N , <:ₜ-poly _ , ())})
...
... | yes refl = map′ (λ{ (T , N , <:₁ , <:₂) → T-Poly T , N-Poly N , <:ₜ-poly <:₁ , <:ₜ-poly <:₂})
                      (λ{ (T , N , <:ₜ-poly <:₁ , <:ₜ-poly <:₂) → _ , _ , <:₁ , <:₂})
                      (meetₜ N₁ N₂)
meetₜ (N-Poly N₁) (N-Sub N₂) = no (λ{ (T₁ , N , <:ₜ-poly _ , ())})
meetₜ (N-Poly N₁) (N-ProtoD N₂) = no (λ{ (T₁ , N , <:ₜ-poly _ , ())})
meetₜ (N-Sub N₁) (N-Var NV) = no (λ{ (T₁ , N , <:ₜ-sub _ , ())})
meetₜ (N-Sub N₁) N-Base = no (λ{ (T₁ , N , <:ₜ-sub _ , ())})
meetₜ (N-Sub N₁) (N-Arrow N₂ N₃) = no (λ{ (T₁ , N , <:ₜ-sub _ , ())})
meetₜ (N-Sub N₁) (N-Poly N₂) = no (λ{ (T₁ , N , <:ₜ-sub _ , ())})
meetₜ (N-Sub {pk₁}{m₁}{km≤ = km≤₁} N₁) (N-Sub {pk₂}{m₂}{km≤ = km≤₂} N₂)
  with eq-prekind pk₁ pk₂
... | no pk₁≢pk₂ = no (λ{ (_ , _ , <:ₜ-sub x₁ , <:ₜ-sub x₂) → pk₁≢pk₂ refl})
... | yes refl
  with eq-multiplicity m₁ m₂
...
... | yes refl
  ...
  = map′ (λ{ (_ , _ , <:₁ , <:₂) → T-Sub km≤₂ _ , N-Sub _ , <:ₜ-sub <:₁ , <:ₜ-sub <:₂})
         (λ{ (_ , _ , <:ₜ-sub <:₁ , <:ₜ-sub <:₂) → _ , _ , <:₁ , <:₂ })
         (meetₜ N₁ N₂)
meetₜ (N-Sub N₁) (N-Pair N₂ N₃) = no (λ{ (T₁ , N , <:ₜ-sub _ , ())})
meetₜ (N-Sub N₁) N-End = no (λ{ (T₁ , N , <:ₜ-sub _ , ())})
meetₜ (N-Sub N₁) (N-Msg p N N₂) = no (λ{ (T₁ , N , <:ₜ-sub _ , ())})
meetₜ (N-Sub N₁) (N-ProtoD N₂) = no (λ{ (T₁ , N , <:ₜ-sub _ , ())})
meetₜ N-End (N-Var NV) = no (λ{ (T₁ , N , <:ₜ-end , ())})
meetₜ N-End (N-Arrow N₂ N₃) = no (λ{ (T₁ , N , <:ₜ-end , ())})
meetₜ N-End (N-Sub N₂) = no (λ{ (T₁ , N , <:ₜ-end , ())})
meetₜ N-End N-End = yes (T-End , N-End , <:ₜ-end , <:ₜ-end)
meetₜ (N-Msg p N N₁) (N-Var NV) = no (λ{ (T₁ , N , <:ₜ-msg _ _ , ())})
meetₜ (N-Msg p N N₁) (N-Arrow N₂ N₃) = no (λ{ (T₁ , N , <:ₜ-msg _ _ , ())})
meetₜ (N-Msg p N N₁) (N-Sub N₂) = no (λ{ (T₁ , N , <:ₜ-msg _ _ , ())})
...
meetₜ (N-ProtoD N₁) (N-Poly N₂) = no (λ{ (T₁ , N , <:ₜ-data _ , ())})
meetₜ (N-ProtoD N₁) (N-Sub N₂) = no (λ{ (T₁ , N , <:ₜ-data _ , ())})
