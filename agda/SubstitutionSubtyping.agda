...
subst-preserves-≡c (≡c-pair T₁≡T₂ T₁≡T₃) ϕ = ≡c-pair (subst-preserves-≡c T₁≡T₂ ϕ) (subst-preserves-≡c T₁≡T₃ ϕ)
...
subst-preserves (<:-pair T₁<:T₂ T₁<:T₃) ϕ = <:-pair (subst-preserves T₁<:T₂ ϕ) (subst-preserves T₁<:T₃ ϕ)
...
subst-preserves (<:-msg-minus refl) = λ ϕ → <:-msg-minus refl
subst-preserves (<:-minus-msg refl) = λ ϕ → <:-minus-msg refl
...
subst-preserves (<:-dual-dual-l-new d) ϕ = <:-dual-dual-l-new d
subst-preserves (<:-dual-dual-r-new d) ϕ = <:-dual-dual-r-new d
...
subst-preserves (<:-dual-msg-l-new refl) ϕ = <:-dual-msg-l-new refl
subst-preserves (<:-dual-msg-r-new refl) ϕ = <:-dual-msg-r-new refl
