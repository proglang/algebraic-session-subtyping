...
subtype-inference N-Base (N-Poly N₂) = no λ()
...
subtype-inference (N-Pair N₁ N₂) (N-Poly N₃) = no λ()
subtype-inference (N-Pair N₁ N₂) (N-Sub N₃) = no λ()
subtype-inference (N-Pair N₁ N₂) (N-ProtoD N₃) = no λ()
subtype-inference (N-Poly N₁) (N-Var NV) = no λ()
subtype-inference (N-Poly N₁) N-Base = no λ()
subtype-inference (N-Poly N₁) (N-Pair N₂ N₃) = no λ()
...
subtype-inference (N-Sub N₁) (N-Pair N₂ N₃) = no λ()
