...
subtype-inference (N-Arrow {pk₁ = pk₁} {m₁ = m₁} {pk₂ = pk₂} {m₂ = m₂} N₁ N₂)
...
subtype-inference (N-Arrow N₁ N₂) (N-Poly _ N₃) = no λ()
subtype-inference (N-Arrow N₁ N₂) (N-Sub _ N₃) = no λ()
...
subtype-inference (N-Pair N₁ N₂) (N-Arrow N₃ N₄) = no λ()
...
subtype-inference (N-Poly _ N₁) (N-Arrow N₂ N₃) = no λ()
...
subtype-inference (N-Sub _ N₁) (N-Arrow N₂ N₃) = no λ()
